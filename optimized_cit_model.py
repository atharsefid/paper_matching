            ...
            for csx_citation in CSXcitations:
                ...
                while (label ==1):
                    ...
                    for hit in response:
                        ...
                        wosAuthors = parse_wos_authors(hit['citedAuthor'])
                        features = SimilarityProfile.calcFeatureVector(csx_citation, csx_citation['authors'], wos_citation, wosAuthors)
                        f.write('csx cit:'+ csx_citation['title']+'\n')
                        f.write('wos cit:'+wos_citation['title']+'\n')
                        f.write('csx cit auth:'+ str(csx_citation['authors'])+'\n')
                        f.write('wos cit auth:'+str(wosAuthors)+'\n')
                        ...
                        if label==1:
                            ...
                            f.write('main paper:'+ str(CSX_paper['title'])+'\n')
                            f.write('candidate paper:'+str(WOS_paper['title'])+'\n')
