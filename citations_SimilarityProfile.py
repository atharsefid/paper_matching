...
class SimilarityProfile(object):
    ...
    def calcFeatureVector(p1, a1s, p2, a2s):
        ...
        def calcBOWcosine(title1, title2, abstract1, abstract2, featVector):
            TF1 = collections.Counter(SimilarityProfile.normalizr.normalize(xstr(title1)+' '+ xstr(abstract1), SimilarityProfile.normalizations).split())
            TF2 = collections.Counter(SimilarityProfile.normalizr.normalize(xstr(title2)+' '+ xstr(abstract2), SimilarityProfile.normalizations).split())
        ...
        def calcTitleBOWjaccard(title1, title2, featVector):
            if title1 is None or title2 is None or title1 == '' or title2 == '':
                ...
                bow1 = SimilarityProfile.normalizr.normalize(xstr(title1), SimilarityProfile.normalizations).split()
                bow2 = SimilarityProfile.normalizr.normalize(xstr(title2), SimilarityProfile.normalizations).split()
